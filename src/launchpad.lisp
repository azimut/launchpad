...
(defun button-scene-xy-on (button)
  ...
  (let ((n (aref #(1 3 5 7 9 11 13 15) button)))
    (raw-command (list 144 (* 8 n) #b0110001))))
(defun button-scene-xy-off (button)
  (declare (type (integer 0 7) button))
  (let ((n (aref #(1 3 5 7 9 11 13 15) button)))
    (raw-command (list 128 (* 8 n) 0))))
(defun button-scene-drum-on (button)
  (declare (type (integer 0 7) button))
  (raw-command (list 144 (+ 100 button) #b0110001)))
(defun button-scene-drum-off (button)
  (declare (type (integer 0 7) button))
  (raw-command (list 128 (+ 100 button) 0)))

(defun button-automap-on (button)
  (declare (type (integer 0 7) button))
  (raw-command (list 176 (+ 104 button) #b0110000)))
(defun button-automap-off (button)
  (declare (type (integer 0 7) button))
  (raw-command (list 176 (+ 104 button) 0)))
